...
const CategorySwitcher = ({ categories, activeCategory, onCategoryChange }) => {
    return (
        <div className="border-b border-gray-100  bg-(--color-accent)/5">
            <div className="max-w-[1440px] mx-auto px-4 sm:px-10 lg:px-30">
                <div className="flex gap-8 overflow-x-auto scrollbar-hide items-center h-[50px]">
                    {categories.map((category) => {
                        ...
                        return (
                            <button
                                ...
                                className={`
                                    relative whitespace-nowrap h-full flex items-center text-sm font-medium transition-colors outline-none
                                    ${isActive
